...
def create_csv(keyword, dates, values):
    ...
    filename = f"BR_{keyword.replace(' ', '_')}_{random_number}.csv"
...
def main():
    ...
    # Create BRindex.txt file
    index_path = os.path.join('dbase', 'BRindex.txt')
    ...
    print(f"\nBRindex.txt has been created with the following content:")
