...
tool_file_dic = {
    "Just in Time": ["justintime.csv", ["Just in Time"],"GB_Just_in_time.csv", "", "CR_Just_in_Time.csv"],
    "Outsourcing": ["outsourcing.csv", ["Outsourcing"],"GB_Outsourcing.csv", "", "CR_Outsourcing.csv"],
    "Project Management": ["projectmanagement.csv", ["Project Management"],"GB_Project_Management.csv", "", "CR_Project_Management.csv"],
    "Strategic Planning": ["strategic_planning.csv", ["Strategic Planning"],"", "", "CR_Strategic_Planning.csv"],
