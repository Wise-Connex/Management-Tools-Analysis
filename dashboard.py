...
membrete = html.Div(
    [
        html.Div([
            html.H6("Enfoque Central de la Investigación Doctoral: Dicotomía Ontológica en las 'Modas Gerenciales'", className="mb-0"),
    ...
    dbc.Row([
        ...
        dbc.Col([
            ...
            html.Div(id='main-title', style={
                'fontSize': '18px',  # Changed from '30px' to '20px'
